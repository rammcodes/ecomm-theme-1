...
export default function Product() {
  return (
    <>
      ...
      <section className="product5-main">
        <div className="container">
          ...
          <div className="product5-main__row">
            <div className="product5-main__row-item">
              <div className="product5-main__visual">
                <div className="product5-main__all-images">
                ...
                <div className="product5-main__big-img-cont">
                  <img
                    src="./png/prd-big-img.png"
                    alt="product image"
                    className="product5-main__big-img"
                  />
                </div>
              </div>
            </div>
            <div className="product5-main__row-item">
              <h2 className="heading heading-section product5-main__title">
                <span className="heading-section__top">Orla Kiely</span>
                <span className="heading-section__main">
                  Orla Kiely Laurel Chair
                </span>
              </h2>
              <p className="product5-main__desc">
                The furniture we offer are very high quality, than other stores.
                Take a look at our product line of high quality furniture.
              </p>
              <div className="product5-main__prices">
                <span className="product5-main__price-prev">
                  {' '}
                  <s> $890 </s>{' '}
                </span>
                <span className="product5-main__price-curr">$678</span>
              </div>
              <div className="product5-main__cart-actions">
                <div className="product5-main__cart-counter">
                  <span className="product5-main__cart-counter-btn">-</span>
                  <span className="product5-main__cart-counter-txt">2</span>
                  <span className="product5-main__cart-counter-btn product5-main__cart-counter-btn-dark">
                    +
                  </span>
                </div>
                <div className="product5-main__cart-main">
                  <button className="product5-main__cart-main-btn">
                    Add to cart
                  </button>
                  <button className="product5-main__cart-main-btn product5-main__cart-main-btn-lt">
                    Add to cart
                  </button>
                </div>
              </div>
              <div className="product5-main__info">
                <div className="product5-main__info-opts">
                  <button className="product5-main__info-opt product5-main__info-opt--active">
                    Product Details
                  </button>
                  <button className="product5-main__info-opt">
                    Specifications
                  </button>
                  <button className="product5-main__info-opt">Reviews</button>
                </div>
                <div className="product5-main__info-main">
                  <p className="product5-main__info-main-para">
